...
$headers  = "MIME-Version: 1.0\n";
     ...
     $msg="Your password reset link <br> http://skylineautoservices.co/admin/Test1/password-reset.php?token=".$token." <br> Reset your password with this link .Click or open in new tab<br><br> <br> <br> <center>".$credits."</center>"; 
...
?>
You can understand the code by the points a