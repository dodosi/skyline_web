								...
								<form action="" method="post"> 
									...
									<div class="card-header">  
										<label for="title">Send nofitications:</label> 
										 <button type="submit" name="submitAnnually" class="btn btn-default button1 float-right" data-toggle="modal"  title="Send annual reminder"> <i class="fa fa-paper-plane text-primary"></i> Annualy</button> 
