                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header"> 
								 <strong class="card-title"><i class="fa fa-edit"></i> Manage Services</strong>
...
<div class="modal fade" id="addCategoriesModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createService.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h5 class="modal-title"><i class="fa fa-plus"></i> <b>Add New Service</b></h5>
	      </div>
	      <div class="modal-body">
            ...
            <div class="form-group">
	        	<label for="serviceName" class="col-sm-4 control-label">Service Name: </label> 
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="serviceName" placeholder="Service Name" name="serviceName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->  	
	        <div class="form-group">
	        	<label for="categoryName" class="col-sm-4 control-label">Category Name: </label> 
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="categoryName" placeholder="Category Name" name="categoryName" >
						...
						$sql = "SELECT id, categoryName, categoryDescription, creationDate, updationDate, category_thumbnail, category_status, category_active FROM category WHERE category_active = 1";
...
<div class="modal fade" id="editCategoriesModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editService.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-categories-result">
		      	<div class="form-group"> 
		        	<label for="editServicesName" class="col-sm-4 control-label">Service Name </label> 
					    <div class="col-sm-8">
					      <input type="text" class="form-control" id="editServicesName" placeholder="Service Name" name="editServicesName" autocomplete="off">
					    </div>
		        </div> <!-- /form-group-->	
	        <div class="form-group">
	        	<label for="editcategoryName" class="col-sm-4 control-label">Category Name: </label> 
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="editcategoryName" placeholder="Category Name" name="editcategoryName" >
				      	<option value="">~~SELECT~~</option>
				      	<?php 
				      	$sql = "SELECT id, categoryName, category_active, category_status FROM category WHERE category_status = 1 AND category_active = 1";
								$result = $connect->query($sql);
				...
				<div class="form-group">
		        	<label for="editCategoriesStatus" class="col-sm-4 control-label">Service Status </label>
					    ...
					    <div class="col-sm-8">
					      <select class="form-control" id="editcategoryStatus" name="editCategoriesStatus">
					      	<option value="">~~SELECT~~</option>
					      	<option value="1">Available</option>
					      	<option value="2">Not Available</option>
					      </select>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeCategoriesModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="fa fa-trash"></i> Remove Service</h4>
      </div>
	...
	<script src="custom/js/services.js"></script>
