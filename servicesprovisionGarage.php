...
<div class="modal fade" id="addCategoriesModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createServiceProviderGarage.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="garageName" class="col-sm-4 control-label">Garage Name: </label> 
				    <?php
					  $sql = "SELECT garageID, Name, active, status FROM garagetbl WHERE status = 1 AND active = 1 AND garageID ={$garageID}";
					?>
				    <div class="col-sm-8">
...
<div class="modal fade" id="editCategoriesModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editServiceProviderGarage.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeCategoriesModal1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="fa fa-trash"></i> Activate Service </h4>
      </div>
      <div class="modal-body">
	...
	<script src="custom/js/servicesproviderGarage.js"></script>
