...
if(!empty($_GET['invoice_id']) && $_GET['invoice_id']) {
	...
	$invoiceValues = $invoice->getInvoice1($_GET['invoice_id']);
    //die("The key is ".$invoiceValues);	 	
...
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	...
	<img src="images/Skyline-logo3.png" width="200" height="100">
	  
	</td>
	</tr>
	<tr><td  colspan="2" align="center" style="font-size:18px">Invoice</td></tr>
	<tr>
	<td colspan="2">
...
foreach($invoiceItems as $invoiceItem){
	...
	<td align="left">'.$invoiceItem["order_item_quantity"]*$invoiceItem["order_item_price"].'</td>   
	</tr>';
}
$output .= '
	<tr>
