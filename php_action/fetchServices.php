...
$sql = "SELECT servicestbl.servID, servicestbl.serviceName, category.categoryName,servicestbl.status FROM category,servicestbl WHERE category.id = servicestbl.serviceCategory AND servicestbl.active=1";
