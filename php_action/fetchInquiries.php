...
$sql = "SELECT contactus.id, contactus.names, contactus.email, contactus.phone, contactus.message, contactus.date FROM `contactus`, customertbl WHERE customertbl.email = contactus.email AND customertbl.user_type = 'Customer'  ORDER BY contactus.date DESC";
