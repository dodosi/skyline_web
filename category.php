                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header"> 
								 <strong class="card-title"><i class="fa fa-edit"></i> Manage Service Categories</strong>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategory.php" method="POST">
	      <div class="modal-header">
	        ...
	        <h5 class="modal-title"><i class="fa fa-plus"></i> <b>Add New Service Category</b></h5>
	      </div>
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="categoriesStatus" class="col-sm-4 control-label">Category Status </label> 
				    <div class="col-sm-8">
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editCategories.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-categories-result">
				...
				<div class="form-group">
		        	<label for="editCategoriesStatus" class="col-sm-4 control-label">Category Status </label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeCategoriesModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="fa fa-trash"></i>Disactivate Category</h4>
      </div>
